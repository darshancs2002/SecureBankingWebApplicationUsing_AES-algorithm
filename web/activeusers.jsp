...
<html>
    ...
    <body>
        ...
        <div class="outer">
            <table>
                <th>ACTIVE USERS</th>
                <tr><th>FIRST NAME</th><th>LAST NAME</th><th>ACCOUNT NO</th><th>ACC CREATED DATE</th><th>STATUS</th></tr>

                <%
                    rst = stmt.executeQuery("select * from activeuserss where isActive='True'");
                    while (rst.next()) {
                        out.println("<tr><td>" + rst.getString("first") + "</td><td>" + rst.getString("second") + "</td><td>" + rst.getString("random") + "</td><td>" + rst.getString("date") + "</td>");
