...
<html>
    ...
    <body onload="Date1(),generateRandomNumber();">
        ...
        <div class="enter">
            <form name="test" method="post" action="depositcheck.jsp" >
                <table>
                    <h1>DEPOSIT</h1>
                    <p>Deposit Money into user account</p>
                    ...
                    <tr><td colspan="4" align="center"><input type="submit"  value="DEPOSIT"/> </td></tr>
