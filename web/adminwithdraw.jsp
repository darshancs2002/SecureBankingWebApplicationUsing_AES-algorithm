...
<html>
    ...
    <body onload="Date1(),generateRandomNumber();">
        ...
        <script>
         ...
         <div class="enter">
            <form name="test" method="post" action="withdrawcheck.jsp" >
                <table>
                    <h1>Withdraw</h1>
                    <p>WithDraw Money from user account</p>
                    <tr><td>ACC NO</td><td><input type="text" name="accno" pattern="[0-9]+" title="Please enter numbers only" required/></td></tr>
                     <tr><td>PIN</td><td><input type="text" name="password" pattern="[0-9]+" title="Please enter numbers only" required/></td></tr>
                    <tr><td>AMOUNT</td><td><input type="text" name="amount" pattern="[0-9]+" title="Please enter numbers only" required/></td></tr>
                    <tr><td colspan="4" align="center"><input type="submit" value="WITHDRAW"/> </td></tr>
