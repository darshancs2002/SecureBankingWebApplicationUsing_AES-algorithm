...
<html>
    ...
    <body>
        ...
        <div class="outer">
            <table>
                <th>REJECTED USER ACCOUNTS</th>
                <tr><th>FIRST NAME</th><th>LAST NAME</th><th>EMAIL</th><th>MOBILE</th><th>STATE</th><th>STATUS</th></tr>

                <%
                    rst = stmt.executeQuery("select * from activeuserss where isActive='Rejected'");
                    while (rst.next()) {
